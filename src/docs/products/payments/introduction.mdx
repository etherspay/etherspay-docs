...
In order to create your first project you will need to create an Etherspay account, you can create an account at [<mark>https://etherspay.com/</mark>](https://etherspay.com/login)
